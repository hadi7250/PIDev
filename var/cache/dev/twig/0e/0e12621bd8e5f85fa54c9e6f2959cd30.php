    ...
    <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["u"]) {
            ...
            yield "                                <tr>
                                    <td>";
            // line 19
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["u"], "name", [], "any", false, false, false, 19), "html", null, true);
            yield "</td>
                                    <td>";
            // line 20
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["u"], "email", [], "any", false, false, false, 20), "html", null, true);
            yield "</td>
                                    <td>";
            // line 21
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::join(CoreExtension::getAttribute($this->env, $this->source, $context["u"], "roles", [], "any", false, false, false, 21), ", "), "html", null, true);
            yield "</td>
                                </tr>
                            ";
        ...
        if (!$context['_iterated']) {
            // line 24
            yield "                                <tr><td colspan=\"3\">Aucun utilisateur</td></tr>
                            ";
        }
...
";
    ...
    {
        return array (  145 => 26,  138 => 24,  136 => 23,  129 => 21,  125 => 20,  121 => 19,  118 => 18,  113 => 17,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}", "dashboard/users.html.twig", "C:\\Users\\rajhi\\pidev-education-app\\templates\\dashboard\\users.html.twig");
    }
}
